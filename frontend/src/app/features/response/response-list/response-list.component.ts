...
export class ResponseListComponent implements OnInit {
  ...
  fetchResponses(): void {
    this.http.get<any[]>(`http://localhost:8082/responses/surveys/${this.surveyId}`)
      .subscribe(
        (data) => {
          this.responses = data;
        },
  ...
  fetchSurveyDetails(): void {
    this.http.get<any>(`http://localhost:8082/surveys/${this.surveyId}`)
      .subscribe(
        (data) => {
          this.survey = data;
        },
  ...
  fetchUserDetails(): void {
    this.http.get<any[]>('http://localhost:8082/users')
      .subscribe(
        (data) => {
          this.users = data;
        },
